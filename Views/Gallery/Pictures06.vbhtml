@Code
    ...
    Dim folder As String = "/Content/Gallery/Pictures/06/"
...
<div Class="container px-4 px-lg-5">
    ...
    <div Class="row gx-4 gx-lg-5 my-3">
        <h3 class="text-center">
            ...
            <span class="text-white">Pictures:</span><span class="text-light fs-4"> 6</span>
        </h3>
    ...
    <div class="row gx-1 gx-lg-5">
        ...
        <div class="col-3 mb-2">
            <div class="h-100 text-center text-white">
                <a class="btn btn-dark btn-sm my-group-buttons" href="~/Gallery/Pictures06">6</a>
            </div>
        </div>
