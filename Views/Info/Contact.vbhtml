...
<!-- Container -->
<div Class="container px-sm-0 px-md-4 px-lg-4 px-xl-4 my-sm-0 my-md-4 my-lg-4 my-xl-4">

    <!-- Content Row-->
    <div class="row gx-2 gx-med-3 gx-lg-5 gx-xl-5 gx-xxl-5">
...
<div Class="container px-4 my-4 ">
    ...
    <!-- Content Row -->
    <div class="row gx-1 gx-lg-5 py-sm-0 py-md-0 pt-lg-4 pt-xl-4 pb-sm-0 pb-md-3 pb-lg-2 pb-xl-2">
